...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    res.json({
      message:
        'Student progress saved/updated successfully.',
      data: doc
    });
    ...
    console.error(
      'Error in POST /student-progress:',
      err
    );
...
router.post('/bulk', async (req, res) => {
  ...
  try {
    ...
    const result = await StudentProgress.bulkWrite(
      ops,
      { ordered: false }
    );
    ...
    // SSE EVENT
    emitNoticeChanged({
      type: 'student-progress-bulk-updated',
      className,
      section,
      subject,
      date: normDate
    ...
    console.error(
      'Error in /student-progress/bulk:',
      err
    );
...
router.get('/class', async (req, res) => {
  ...
  try {
    ...
    console.error(
      'Error in GET /student-progress/class:',
      err
    );
...
router.get('/student/:studentId', async (req, res) => {
  ...
  try {
    ...
    console.error(
      'Error in GET /student-progress/student/:studentId:',
      err
    );
...
router.put('/:id', async (req, res) => {
  ...
  try {
    ...
    if (!payload.studentRemark) {
      payload.studentRemark = '';
    }

    if (!payload.studentRemarkDate) {
      payload.studentRemarkDate = null;
    }
    ...
    // SSE EVENT
    emitNoticeChanged({
      type: 'student-progress-record-updated',
      id
    });
    ...
    console.error(
      'Error in PUT /student-progress/:id:',
      err
    );
...
router.delete('/:id', async (req, res) => {
  ...
  try {
    ...
    console.error(
      'Error in DELETE /student-progress/:id:',
      err
    );
